...
The Cardboard Viewer can be any brand, but it should at least work with your iPhone's screen size and contain a QR code viewer profile at the bottom <img src="docs/QR.png" width="48">. Moreover, you need to make sure to cut a small hole on the front of your viewer to avoid occulde the camera at the back of our iPhone.
