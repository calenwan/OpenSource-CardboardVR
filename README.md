...
The Cardboard Viewer can be any brand, but it should at least work with your iPhone's screen size and contain a QR code viewer profile at the bottom.<img src="docs/QR.png" width="250"> 

Moreover, you need to make sure to cut a small hole on the front of your viewer to avoid occulde the camera at the back of our iPhone.<img src="docs/Cut.png" width="250">

The VR controller, however, can be any brand but need to have the exact same type (shape and buttons) like this <img src="docs/Controller.png" width="250">.
